...
覆盖 ESP（乐鑫）系列芯片的 Arduino / ESP-IDF 固件 SDK，以及 Flutter / Go / HarmonyOS / Linux / Windows / Android 平台 SDK，
...
└── 设备侧
    └── thingboot-device ★ 本仓库
        ...
        ├── thingboot-device-go-sdk               芯步设备 Go SDK
...
| [thingboot-device-go-sdk](https://github.com/ThingBoot/thingboot-device-go-sdk) | 芯步设备 Go SDK：面向主机/服务器侧设备接入（软网关、边缘服务、云侧模拟设备），协议与 C++ 版逐字节一致 |
